  ...
  <div class="cart-container ">
    ...
    <ul>
      <li v-for="item in cart" :key="item.id">
       ...
       {{ item.price }} DKK 
        <button class="buttonone" @click="removeCartItem(item.id)">Remove</button>
      </li>
    </ul>
    <p class="mb-5"> <strong>Total:</strong>  {{ cartTotal }} DKK</p>
    
    <button class="" @click="clearCart">Clear cart</button>
    <button class="buttontwo" @click="purchase">Purchase</button>
