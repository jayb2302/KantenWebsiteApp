<template>
  <teleport to="body">
    ...
    >
      ...
      >
        <div
          class="flex justify-center overflow-auto scrollbar h-4/5 lg:h-5/6 pt-14 lg:pt-16 mt-4"
        >
          <div
            class="modal overflow-auto hover:overflow-auto scrollbar-thin shadow-md shadow-slate-500 shadow-inner w-11/12 pt-4 p-8 lg:mb-2 h-full mb-2"
            role="dialog"
            ref="modal"
          >
            ...
            <div
              class="aboutme bb flex flex-col justify-center h-auto w-11/12 m-auto pt-1"
            >
              <div
                class="flex rb place-self-center flex-col w-8/12 mb-4 h-72"
              ></div>
              <div
